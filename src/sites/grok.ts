...
const KW = {
  input: ["textbox", "textarea", "输入", "你想知道什么"],
...
async function main() {
  ...
  if (args.length === 0) { console.log('用法: npx tsx src/sites/grok.ts "提示词" [--file ./img.png]'); process.exit(0); }
